...
## Simply Legacy
![Simply Legacy In-Game](./simply/game.png)
...
::: details
![Simply Legacy Manual Saving](./simply/save.png)
:::
- All LCE Mash-up Worlds
::: details
![Simply Legacy Mash-Up Worlds](./simply/mash.png)
:::
- Most of the LCE Texture Packs (not all due to DMCA complications)
::: details
![Simply Legacy Texture Packs](./simply/packs.png)
:::
- LCE Skin Packs
::: details
![Skin Packs](./simply/skins.png)
:::
- Programmer Art Continuation Project (by mzov_jen) installed by default
::: details
![Simply Legacy PACP](./simply/pacp.png)
:::
- Entity Model Features and Entity Texture Features
::: details
![Simply Legacy EMF/ETF](./simply/emf.png)
:::
- LCE or LCE-style Mini Games: Glide and Fistfight currently
::: details
![Simply Legacy Glide Mini Game](./simply/mm.png)
:::
- Limited World Sizes and Biome Scale
::: details
![Simply Legacy World Sizes](./simply/sizes.png)
![Simply Legacy World Sizes Map](./simply/sizes-map.png)
:::
- [Custom Legacy4J Options Presets](./options-presets)
  - Render Distance maxes out at 64 chunks
  - Easily enable/disable the Fake Autosave Screen
::: details
![Simply Legacy Options Presets](./simply/presets.png)
![Simply Legacy Extreme Preset](./simply/extreme.png)
![Simply Legacy Fake Autosave Screen](./simply/save-screen.png)
:::
- Custom Minecraft Logos
::: details
![Simply Legacy Steam Machine Edition](./simply/title.png)
:::
- Borderless Fullscreen
  - Enables use of `Force Active Window` so you can play without having the game window focused

## Re-Console+
![Re-Console+ In-Game](./rc/game.png)
...
::: details
![Re-Console+ Texture Packs](./rc/packs.png)
:::
- All Tutorial World Versions
::: details
![Re-Console+ Tutorial World Addon](./rc/tut.png)
:::
- Bedrock-Style Block Placing/Bridging
::: details
![Re-Console+ Bedrock Bridging](./rc/bridging.png)
:::
- Additional OptiFine Features
  ...
  - Zoom
::: details
![Re-Console+ OptiFine Features](./rc/of.png)
:::
- Shader Support with bundled shaders
::: details
![Re-Console+ Shaders](./rc/shaders.png)
:::
- C2ME and FastQuit
::: warning
...
:::
::: details
![Re-Console+ Saving](./rc/save.png)
![Re-Console+ FastQuit](./rc/fastquit.png)
:::
- Idle Enhancements
...
- Simple Voice Chat
::: details
![Re-Console+ Simple Voice Chat](./rc/vc.png)
:::
- Various HUD Mods
  - BetterF3
  - Ping View
::: details
![Re-Console+ BetterF3/Ping View](./rc/f3.png)
